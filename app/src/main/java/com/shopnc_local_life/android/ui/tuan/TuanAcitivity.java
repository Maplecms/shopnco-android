...
//		dialog =new MyProcessDialog(TuanAcitivity.this);
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent intent =new Intent(TuanAcitivity.this,TuanDetailsActivity.class);
...
//			dialog.dismiss();
			Toast.makeText(TuanAcitivity.this, "城市没有获取到，请稍后重试", Toast.LENGTH_SHORT).show();
			listview.removeFooterView(moreView);
			listview.onRefreshComplete();
			return ;
		}
		flag=myApp.getCity_id();
		String url=Constants.URL_GROUPBUY_LIST+"&city_id="+myApp.getCity_id()+"&pagenumber="+pangeno+"&pagesize="+Constants.PARAM_PAGESIZE;
...
//					}
					...
					listview.removeFooterView(moreView);
					listview.onRefreshComplete();
					Toast.makeText(TuanAcitivity.this, "加载团购列表失败，请稍后重试", Toast.LENGTH_SHORT).show();
				}
			}
		});
	}
...
//				finish();
//			}
			((MainActivity) TuanAcitivity.this.getParent()).dialog.show();
			return true;
		} else {
